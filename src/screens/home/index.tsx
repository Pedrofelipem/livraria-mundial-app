    ...
    <View style={styles.background}>
      ...
      <View style={styles.containerPromo}>
        <Image
          ...
          source={require("../../assets/imagens/cupom-20.png")}
        />
      </View>
      <View
        style={{
      ...
      >
        <Image
          style={styles.logoCategoria}
          source={require("../../assets/imagens/cate1.png")}
        />
        <Image
          style={styles.logoCategoria}
          source={require("../../assets/imagens/cate2.png")}
        />
        <Image
          style={styles.logoCategoria}
          source={require("../../assets/imagens/cate3.png")}
        />
        <Image
          style={styles.logoCategoria}
          source={require("../../assets/imagens/cate4.png")}
        />
      </View>
      <View
        style={{
      ...
      >
        <TouchableOpacity
          style={{ backgroundColor: "#00134d", width: 120, borderRadius: 5 }}
          onPress={() => nav.navigate("produto")}
        >
          <Image
            style={styles.imageProduto}
            source={require("../../assets/imagens/img-arte.jpg")}
          />
