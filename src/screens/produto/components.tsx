  ...
  return (
    <View>
      ...
      <View>
        <View style={styles.conteiner}>
          ...
          <View style={styles.conteinerValor}>
            ...
            <Text style={styles.precoParcela}>à vista</Text>
            <Text style={styles.precoParcela}>Em até 1x de R$ 49,99</Text>
          </View>
          <Button buttonStyle={[styles.btnComprar]} title="COMPRAR" />
          <Button
            buttonStyle={[styles.btnCarrinho]}
            title="CARRINHO"
      ...
      <View style={styles.descricaoConteiner}>
        ...
        <Text style={styles.descricaoLivro}>
          Mark manson não tem meandros ou meias palavras. Com um estilo honesto,
          divertido e incrivelmente perspicaz, ele se tornou popular escrevendo
          em seu blog o que as pessoas realmente precisam ouvir, pois só isso
          funciona para nos fazer evoluir pessoal e profissionalmente. Mora em
          Nova York.
        </Text>
      </View>
    </View>
