    ...
    return (
            <View style={styles.background}>
              ...
              <View style={styles.conteinerLogoFrete}>
                <Image style={styles.logoFrete} source={require('../.././frete.png')}/>
              ...
              <TouchableOpacity style={styles.containerPromo}>
                <Image style={styles.imgPromo} source={require('../.././cupom-20.png')}/>
              </TouchableOpacity>
              <View style={{flexDirection:'row', width:400,height:10, justifyContent:'space-around',}}>
                <Image style={styles.logoCategoria} source={require('../.././cate1.png')}/>
                <Image style={styles.logoCategoria} source={require('../.././cate2.png')}/>
                <Image style={styles.logoCategoria} source={require('../.././cate3.png')}/>
                <Image style={styles.logoCategoria} source={require('../.././cate4.png')}/>
              </View>
